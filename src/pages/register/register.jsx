...
export default function RegisterPage() {
    ...
    function handleOnSubmit(e) {
        ...
        axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/users/` ,{
            ...
            toast.error(err?.response?.data?.error||"An error ocuured")
        })
    };
    ...
    return (
        <div className="bg-picture w-full h-screen flex justify-center items-center">
            <form onSubmit={handleOnSubmit}>
                <div className="w-[400px] h-auto p-6 backdrop-blur-xl rounded-2xl flex flex-col items-center">
                    ...
                    <button className="my-6 w-[300px] h-[50px] bg-[#efac38] text-2xl text-white rounded-lg">Register</button>
                </div>
            </form>
        </div>
    );
